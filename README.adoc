= Blue-64
include::doc/resources/header.adoc[]
...
A step-by-step video guide on how to assemble and install the Blue-64 board is available on link:https://youtu.be/yE2yL8-_jRQ?si=YmAZqs-F023yzRW5[YouTube]:
