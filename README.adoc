...
If you would like to get in touch with the developer, please join the SPL xref:https://discord.gg/gJsCgebkDw[Discord] server.
...
- xref:https://retro8bitshop.com/product/spl-blue-64/[Retro8BitShop]
- xref:https://www.retro-updates.com/product/13541624/blue-64-plug-play-bluetooth-for-the-c64[Retro-Updates]
- xref:https://restore-store.de/home/682-blue-64-v03.html?search_query=blue-64&results=7[Restore-Store]
