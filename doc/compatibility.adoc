...
=== Device Support
Blue-64 is based on the xref:https://bluepad32.readthedocs.io/en/latest/[bluepad32] library from Ricardo Quesada. As such it supports the exact same devices (bluetooth controllers & keyboards) as bluepad32.
